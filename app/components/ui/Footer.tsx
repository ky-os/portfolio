                ...
                <div className="border-t border-gray-800/50 mt-8 pt-8 text-center">
                    ...
                    <div className="mt-4 flex justify-center">
                        <Link
                            ...
                            style={{
                                animation: 'easter-egg-pulse 3s ease-in-out infinite'
                            }}
                        >
                            <div className="w-2 h-2 rounded-full bg-red-700/60 group-hover:bg-red-400 transition-colors duration-300"></div>
                            <div className="absolute -inset-1 rounded-full border border-transparent group-hover:border-red-500/40 transition-all duration-300"></div>
                        </Link>
                    </div>
                </div>
            </div>
