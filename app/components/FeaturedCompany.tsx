...
export default function FeaturedCompany({
    ...
    return (
        <Card className="mb-16 relative group overflow-visible border-blue-500/20 bg-gray-900/60">
            <div className="absolute -inset-0.5 bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200 -z-10"></div>
            
            <CardContent className="p-6 md:p-8 relative overflow-hidden rounded-xl">
                        ...
                        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-6">
                            <div className="text-center md:text-left">
                                <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                                    ...
                                    <span className="px-2.5 py-0.5 rounded-full bg-amber-500/10 text-amber-400 text-xs font-bold border border-amber-500/20 uppercase tracking-wider shadow-[0_0_10px_rgba(245,158,11,0.2)] flex items-center gap-1">
